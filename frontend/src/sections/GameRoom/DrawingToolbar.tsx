    ...
    return (
      ...
      >
        <div ref={disabledRef} className="text-center">
          ...
          <p className="text-gray-500">Drawing tools will be available when it's your turn</p>
        </div>
      </div>
    );
  }
            ...
            {colors.map((color) => (
              <button
                ...
                className={`w-8 h-8 rounded-lg border-2 transition-all duration-200 transform hover:scale-110 active:scale-95 ${
                  currentColor === color ? 'border-gray-800 shadow-lg' : 'border-gray-300 hover:border-gray-400'
                }`}
